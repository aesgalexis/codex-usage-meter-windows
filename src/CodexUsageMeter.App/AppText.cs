...
public static class AppText
{
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        ["ShowPinned"] = "Show pinned widget", ["Available"] = "Weekly available: {0}%  ·  Used: {1}%",
        ["ResetAt"] = "Weekly resets: {0}", ["NoReset"] = "Weekly reset: no data", ["NoUsage"] = "No usage data",
        ...
        ["Language"] = "Language", ["UsageChanged"] = "Codex weekly usage changed",
    ...
    private static readonly IReadOnlyDictionary<string, string> Es = new Dictionary<string, string>
    {
        ...
        ["ShowPinned"] = "Mostrar widget fijo", ["Available"] = "Semanal disponible: {0}%  ·  Usado: {1}%",
        ["ResetAt"] = "Reinicio semanal: {0}", ["NoReset"] = "Reinicio semanal: sin datos", ["NoUsage"] = "No hay datos de uso",
        ...
        ["Language"] = "Idioma", ["UsageChanged"] = "El uso semanal de Codex ha cambiado",
